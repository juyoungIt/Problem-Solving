...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!pq.isEmpty()) {
            ...
            for (Route route : al[cur.dest]) {
                if (costs[route.dest] > costs[cur.dest] + route.cost) {
                    costs[route.dest] = costs[cur.dest] + route.cost;
                    pq.add(new Route(route.dest, costs[route.dest]));
                }
            }
        }
